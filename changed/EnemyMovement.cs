...
public class EnemyMovement : MonoBehaviour {
    ...
    [SerializeField] private float bounceDistance;//hoe ver de enemy terug gaat na het moederboord te raken
    [SerializeField] private float spawnDistance;//ongebruikt
